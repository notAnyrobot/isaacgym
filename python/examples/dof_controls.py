...
cartpole_asset = gym.load_asset(sim, ASSET_PATH, asset_file, asset_options)
...
cartpole0 = gym.create_actor(
    env0, cartpole_asset, initial_pose, "cartpole", 0, 1
)
...
cartpole1 = gym.create_actor(
    env1, cartpole_asset, initial_pose, "cartpole", 1, 1
)
# Configure DOF properties
...
cartpole2 = gym.create_actor(
    env2, cartpole_asset, initial_pose, "cartpole", 2, 1
)
# Configure DOF properties
...
cartpole3 = gym.create_actor(
    env3, cartpole_asset, initial_pose, "cartpole", 3, 1
)
# Configure DOF properties
